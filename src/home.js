...
function Home() {
	...
	const ToBookingPagePray = () => {
		navigate("/booking", {
			state: { poster: "./images/preywide.jpg", title: "Prey (2022)" },
		});
	};
	...
	const ToBookingPageBulletTrain = () => {
		navigate("/booking", {
			state: {
				poster: "./images/bullettrain-wide.webp",
	...
	const ToBookingPageLightyear = () => {
		navigate("/booking", {
			state: {
				poster: "./images/lightyear-wide.webp",
